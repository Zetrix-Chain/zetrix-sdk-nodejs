...
module.exports = {
  ...
  INVALID_INITBALANCE_ERROR: {
    CODE: 11004,
    MSG: 'InitBalance must be between 0 and max(int64)',
  },
  ...
  INVALID_ISSUE_AMMOUNT_ERROR: {
    CODE: 11008,
    MSG: 'AssetAmount must be between 1 and max(int64)',
  },
  NO_METADATA_ERROR: {
    CODE: 11010,
  ...
  INVALID_DATAKEY_ERROR: {
    CODE: 11011,
    MSG: 'The length of key must be between 1 and 1024',
  },
  INVALID_DATAVALUE_ERROR: {
    CODE: 11012,
    MSG: 'The length of value must be between 0 and 256000',
  },
  ...
  INVALID_MASTERWEIGHT_ERROR: {
    CODE: 11015,
    MSG: 'MasterWeight must be between 0 and max(uint32)',
  },
  ...
  INVALID_SIGNER_WEIGHT_ERROR: {
    CODE: 11017,
    MSG: 'Signer weight must be between 0 and max(uint32)',
  },
  INVALID_TX_THRESHOLD_ERROR: {
    CODE: 11018,
    MSG: 'TxThreshold must be between 0 and max(int64)',
  },
  ...
  INVALID_TYPE_THRESHOLD_ERROR: {
    CODE: 11020,
    MSG: 'TypeThreshold must be between 0 and max(int64)',
  },
  ...
  INVALID_ASSET_AMOUNT_ERROR: {
    CODE: 11024,
    MSG: 'AssetAmount must be between 0 and max(int64)',
  },
  ...
  INVALID_GAS_AMOUNT_ERROR: {
    CODE: 11026,
    MSG: 'The gasAmount must be between 0 and max(int64)',
  },
  ...
  INVALID_TOKEN_NAME_ERROR: {
    CODE: 11031,
    MSG: 'The length of token name must be between 1 and 1024',
  },
  INVALID_TOKEN_SYMBOL_ERROR: {
    CODE: 11032,
    MSG: 'The length of symbol must be between 1 and 1024',
  },
  INVALID_TOKEN_DECIMALS_ERROR: {
    CODE: 11033,
    MSG: 'Decimals must be between 0 and 8',
  },
  INVALID_TOKEN_TOTALSUPPLY_ERROR: {
    CODE: 11034,
    MSG: 'TotalSupply must be between 1 and max(int64)',
  },
  ...
  INVALID_TOKEN_AMOUNT_ERROR: {
    CODE: 11039,
    MSG: 'Token amount must be between 1 and max(int64)',
  },
  ...
  INVALID_LOG_TOPIC_ERROR: {
    CODE: 11045,
    MSG: 'The length of log topic must be between 1 and 128',
  },
  INVALID_LOG_DATA_ERROR: {
    CODE: 11046,
    MSG: 'The length of one of log data must be between 1 and 1024',
  },
  ...
  INVALID_NONCE_ERROR: {
    CODE: 11048,
    MSG: 'Nonce must be between 1 and max(int64)',
  },
  INVALID_GASPRICE_ERROR: {
    CODE: 11049,
    MSG: 'GasPrice must be between 1 and max(int64)',
  },
  INVALID_FEELIMIT_ERROR: {
    CODE: 11050,
    MSG: 'FeeLimit must be between 1 and max(int64)',
  },
  ...
  INVALID_SIGNATURENUMBER_ERROR: {
    CODE: 11054,
    MSG: 'SignatureNumber must be between 1 and max(int32)',
  },
  INVALID_HASH_ERROR: {
    CODE: 11055,
  ...
  INVALID_OPTTYPE_ERROR: {
    CODE: 11064,
    MSG: 'OptType must be between 0 and 2',
  },
  GET_ALLOWANCE_ERROR: {
    CODE: 11065,
  ...
  INVALID_S_PAYLOAD_ERROR: {
    CODE: 12001,
    MSG: 'sPayload should be boolean',
  },
  INVALID_S_OWNER_ERROR: {
    CODE: 12002,
    MSG: 'sOwner should be boolean',
  },
  INVALID_DELETEFLAG_ERROR: {
    CODE: 12003,
    MSG: 'deleteFlag should be boolean',
  },
  S_PAYLOAD_S_OWNER_NULL_ERROR: {
    CODE: 11077,
    MSG: 'sPayload and sOwner cannot be null at the same time',
  },
  OWNER_NULL_ERROR: {
    CODE: 11078,
    MSG: 'owner parameter cannot be null',
  },
